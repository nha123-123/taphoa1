...
<body>
    ...
    <div class="tong">
        ...
        <div class="formsuanguoidung">
            <span>Thêm mới danh mục hoa</span>
            <form action="" method="POST" class="row">
                ...
                <div class="form-group col-6">
                    ...
                    <input type="number" class="form-control" name="donoibat">
                </div>
                <button class="btn btn-primary" type="submit" name="adddanhmuc">Thêm danh mục</button>
            </form>
        </div>
