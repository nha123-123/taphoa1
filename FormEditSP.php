            ...
            <form action="" method="POST" class="row" enctype="multipart/form-data">
                <div class="form-group col-6">
                    ...
                    <select name="iddanhmuc" id="" class="form-control">
                        <?php
                        while ($row = mysqli_fetch_assoc($tatcadanhmuc1)) { ?>
                ...
                <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control" name="tenhoa" value="<?= $result['tensanpham'] ?>">
                </div>
                <div class="form-group col-6">
                    <label for="">Tiêu đề</label>
                    <input type="text" class="form-control" name="tieude" value="<?= $result['tieude'] ?>">
                </div>
                <div class="form-group col-6">
                ...
                <div class="form-group col-6">
                    ...
                    <input type="number" class="form-control" name="donoibatsp" value="<?= $result['donoibatsp'] ?>">
                </div>
                <div class="form-group col-12">
                    <label for="">Mô tả</label>
                    <input type="text" class="form-control" name="mota" value="<?= $result['mota'] ?>">
                </div>
                <div class="form-group col-6">
                    <label for="">Ghi chú</label>
                    <input type="text" class="form-control" name="ghichu" value="<?= $result['ghichu'] ?>">
                </div>
                <div class="form-group col-6 mt-3">
                    <label for="">Ảnh</label>
                    <img src="<?= $result['anh'] ?>" alt="" style="with:100px; height:100px">
                </div>
                <div class="form-group col-12">
                    <label for="">Thay ảnh khác</label>
                    <input type="file" class="form-control" name="anh" id="anh">
                </div>
                <button class="btn btn-primary" type="submit" name="editsp">Sửa</button>
            </form>
        </div>
