...
<body>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td><img src="<?php echo $row['anh'] ?>" alt="" style="with:50px; height:50px"></td>
                            <td><?php echo $row['soluong'] ?></td>
                            <td><?php echo $row['gia'] ?></td>
                            <td><?php echo $row['mota'] ?></td>
                            <td><?php echo $row['ghichu'] ?></td>
                            <td><?php echo $row['donoibatsp'] ?></td>
                            <td>
                                <div>
                                    <a class="text-danger" href="index.php?task=deletesp&id=<?php echo $row['id'] ?>"><i class="fas fa-trash"></i></a>
                                    <a class="text-danger" href="index.php?task=editsp&id=<?php echo $row['id'] ?>"><i class="fas fa-edit"></i></a>
                                </div>
                            </td>
                        </tr>
                    <?php
    ...
    <button class="btn btn-primary"><a class="abc" href="index.php?task=addsp">Thêm sản phẩm</a></button>
